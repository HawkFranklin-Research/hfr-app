...
package com.hawkfranklin.aura.data
...
data class Model(
   ...
   * - `com.hawkfranklin.aura` for builds from the GitHub source.
   * - `com.hawkfranklin.aura` for other builds (Play store, internal, etc).
   *
   ...
   *
   * /storage/emulated/0/Android/data/com.hawkfranklin.aura/files/my_model/local_dir/
   *
