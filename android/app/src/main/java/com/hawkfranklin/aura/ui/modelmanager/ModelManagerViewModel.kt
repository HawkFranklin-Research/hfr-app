...
package com.hawkfranklin.aura.ui.modelmanager
...
import com.hawkfranklin.aura.common.ProjectConfig
import com.hawkfranklin.aura.common.getJsonResponse
...
import com.hawkfranklin.aura.data.EMPTY_MODEL
import com.hawkfranklin.aura.data.IMPORTS_DIR
import com.hawkfranklin.aura.data.Model
import com.hawkfranklin.aura.data.ModelAllowlist
import com.hawkfranklin.aura.data.ModelDownloadStatus
...
import com.hawkfranklin.aura.data.createLlmChatConfigs
    ...
    viewModelScope.launch(Dispatchers.IO) {
      try {
        ...
        if (modelAllowlist == null) {
          // Load from github.
          val url =
            "https://raw.githubusercontent.com/HawkFranklin-Research/AURA/native-rebuild/model_allowlists/${BuildConfig.VERSION_NAME.replace(".", "_")}.json"
